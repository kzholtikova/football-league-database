...
try:
    ...
    if c.rowcount != 1:
        db.rollback()
        print("Transaction rolled back due to the inconsistent match_day_id - team_id data.")
    ...
    if c.rowcount != 1:
        db.rollback()
        print("Transaction rolled back due to the inconsistent match_id - team_id data.")

    db.commit()  # team 6 - 3:2   team 10 - 4:3   team 30 - 3:2
    print("Transaction's successful.")
